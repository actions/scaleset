...
func init() {
	...
	flags.StringVar(&cfg.GitHubApp.AppID, "app-id", "", "GitHub App application id")
	flags.Int64Var(&cfg.GitHubApp.AppInstallationID, "app-installation-id", 0, "GitHub App installation ID")
	flags.StringVar(&cfg.GitHubApp.AppPrivateKey, "app-private-key", "", "GitHub App private key")
